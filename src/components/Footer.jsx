...
export const Footer = () => {
  return (
    <div className="footer">
        <section className="logo d-flex justify-content-between align-items-center  w-100">
            <Link to={'/'}>
            <img  className="ms-5 mt-3" src="/logo.png" width="100px" alt="Logo"/>
            </Link>
            <article className="me-5">
                ...
                <a href="https://www.facebook.com/creoycreoregalos" target='_blank'>
        ...
        <section className="derechos py-2" >
            <p className="text-center"><small>©Todos los Derechos Reservados</small></p>
        </section>
    </div>
  )
}
